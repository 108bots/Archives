	...
	public void actionPerformed(ActionEvent event) {
		...
		switch(option) {
		  ...
		  case 7:   System.out.println("Captured Button7 Event");
			        ...
			        message = message + "\n";
			        message = message + "Hemanth Balaji Srinivasan (hbs051000) ";
			        message = message + "\n";
			        message = message + "Department of Computer Science ";
			        message = message + "\n";
			        message = message + "University of Texas at Dallas";
			        message = message + "\n";
			        message = message + "\n";
			        message = message + "Course Project: ";
			        message = message + "\n";
			        message = message + "Algorithmic Aspects of Telecom Networks (Fall 2006)";
			        message = message + "\n";
			        message = message + "Instrictor: ";
			        message = message + "\n";
			        message = message + "Prof. Andras Farago";
