...
Each directory has a README file, Please read them first.
...
For System and otherRequirements: See sstf-req.txt
--------------------------------

To Compile and Run SSTF: See sstf-jar-help.txt
------------------------



Launching a Test Case From the GUI
----------------------------------
